...
def draw_cluster(leader1, leader2, cluster1=set(), cluster2=set()):
    ...
    for node in NODES:
        if node == leader1:
            colors.append("blue")  # Líder del primer clúster
        elif node == leader2:
            colors.append("purple")  # Líder del segundo clúster
        elif node in cluster1:
            colors.append("green")  # Nodos del primer clúster
        elif node in cluster2:
            colors.append("yellow")  # Nodos del segundo clúster
        else:
            colors.append("red")  # Nodos en partición de red
